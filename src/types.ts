...
export const DEFAULT_AGENT_NAMES = ["general-purpose", "Explore", "Web Research", "Systematic Debugging", "SEO GEO Agent Search", "Plan", "Implement", "Review", "Remove Slop"] as const;
