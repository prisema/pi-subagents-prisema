...
| `Review` | read, bash, grep, find, ls + FFF search tools | inherit | `replace` (standalone) | Evidence-driven reviewer/validator (read-only, 32-turn cap) |
| `Remove Slop` | read, bash, edit, grep, find, ls + FFF search tools | inherit | `replace` (standalone) | Scoped cleanup for AI-generated slop after implementation/validation (16-turn cap) |
